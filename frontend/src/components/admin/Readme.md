...
In Colorado CareAssist CRM (built on Atomic CRM), these components are sometimes slightly modified to fit the look and feel of the application. You can customize them further by editing the source files in this directory.

## Updates

Shadcn Admin Kit components are actively maintained and updated. To update the components in Colorado CareAssist CRM, type the following command:
